...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>ui.viewbinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxUiTextLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>ui.text.android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RetrofitKotlinLibraryAccessors extends SubDependencyFactory {
        private final RetrofitKotlinCoroutinesLibraryAccessors laccForRetrofitKotlinCoroutinesLibraryAccessors = new RetrofitKotlinCoroutinesLibraryAccessors(owner);

        public RetrofitKotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>retrofit.kotlin.coroutines</b>
         */
        public RetrofitKotlinCoroutinesLibraryAccessors getCoroutines() {
            return laccForRetrofitKotlinCoroutinesLibraryAccessors;
        }

    }

    public static class RetrofitKotlinCoroutinesLibraryAccessors extends SubDependencyFactory {

        public RetrofitKotlinCoroutinesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         * with version reference <b>retrofit2.kotlin.coroutines.adapter</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAdapter() {
            return create("retrofit.kotlin.coroutines.adapter");
        }
    ...
    public static class RetrofitKotlinxSerializationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>retrofit2.kotlinx.serialization.converter</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mockkVersion</b> with value <b>1.13.11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.retrofit2</b>
         */
        public Retrofit2VersionAccessors getRetrofit2() {
            return vaccForRetrofit2VersionAccessors;
        }
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.compose</b> with value <b>2.8.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class Retrofit2VersionAccessors extends VersionFactory  {
        ...
        private final Retrofit2KotlinxVersionAccessors vaccForRetrofit2KotlinxVersionAccessors = new Retrofit2KotlinxVersionAccessors(providers, config);
        public Retrofit2VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.retrofit2.kotlin</b>
         */
        public Retrofit2KotlinVersionAccessors getKotlin() {
            return vaccForRetrofit2KotlinVersionAccessors;
        }

        /**
         * Group of versions at <b>versions.retrofit2.kotlinx</b>
         */
        public Retrofit2KotlinxVersionAccessors getKotlinx() {
            return vaccForRetrofit2KotlinxVersionAccessors;
        }
    ...
    public static class Retrofit2KotlinVersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.retrofit2.kotlin.coroutines</b>
         */
        public Retrofit2KotlinCoroutinesVersionAccessors getCoroutines() {
            return vaccForRetrofit2KotlinCoroutinesVersionAccessors;
        }
    ...
    public static class Retrofit2KotlinCoroutinesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>retrofit2.kotlin.coroutines.adapter</b> with value <b>0.9.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class Retrofit2KotlinxVersionAccessors extends VersionFactory  {

        private final Retrofit2KotlinxSerializationVersionAccessors vaccForRetrofit2KotlinxSerializationVersionAccessors = new Retrofit2KotlinxSerializationVersionAccessors(providers, config);
        public Retrofit2KotlinxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.retrofit2.kotlinx.serialization</b>
         */
        public Retrofit2KotlinxSerializationVersionAccessors getSerialization() {
            return vaccForRetrofit2KotlinxSerializationVersionAccessors;
        }

    }

    public static class Retrofit2KotlinxSerializationVersionAccessors extends VersionFactory  {

        public Retrofit2KotlinxSerializationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>retrofit2.kotlinx.serialization.converter</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getConverter() { return getVersion("retrofit2.kotlinx.serialization.converter"); }

    }

    public static class UiVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        private final UiTextVersionAccessors vaccForUiTextVersionAccessors = new UiTextVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>ui.viewbinding</b> with value <b>1.6.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getViewbinding() { return getVersion("ui.viewbinding"); }

        /**
         * Group of versions at <b>versions.ui.text</b>
         */
        public UiTextVersionAccessors getText() {
            return vaccForUiTextVersionAccessors;
        }

    }

    public static class UiTextVersionAccessors extends VersionFactory  {

        public UiTextVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>ui.text.android</b> with value <b>1.6.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroid() { return getVersion("ui.text.android"); }
